...
//                    + " where u.idUtilisateur = ?";
    ...
    public ArrayList recupListeAdresses(DataSource ds, ConnexionBean cB, Long idUtilisateur) {
        ...
        ds = cB.MaConnexion();
        try (Connection c = ds.getConnection()) {
            String query = "select  a.idAdresse, numero, voie, codePostal, ville, complement, libelle from DernieresFacturations as ds "
            ...
            while (rs.next()) {
                ...
                myAL.add(a);
//                System.out.println(a.getId()+" - "+a.getNumero()+" "
//                        +a.getVoie()+" "+a.getCp()+" "
